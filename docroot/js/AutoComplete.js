    ...
    */
    function AutoComplete_Create (id, data)
    {
        ...
        __AutoComplete[id]['element'].onclick    = function(e) {if (!e) e = window.event; e.cancelBubble = true; e.returnValue = false; updateUsersBox();}
    ...
    */
    function AutoComplete_ShowDropdown(id)
    {
        ...
        for (i=0; i<__AutoComplete[id]['data'].length; ++i) {
            if (__AutoComplete[id]['data'][i].toLowerCase().substr(0, value.toLowerCase().length) == value.toLowerCase()) {
